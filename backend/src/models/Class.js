...
const Class = sequelize.define('Class', {
  ...
  estado: { type: DataTypes.ENUM('activa', 'cancelada', 'completa'), defaultValue: 'activa' },
  imagen: { type: DataTypes.STRING, allowNull: true, defaultValue: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=600&h=400&fit=crop' }
}, {
  tableName: 'clases',
  timestamps: true
});
